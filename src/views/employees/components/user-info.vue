      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="员工头像">
            <!-- 放置上传图片 -->
            <ImageUpload ref="employeesHeader" @onSuccess="headerImgSuccess" />
          </el-form-item>
        </el-col>
      </el-row>
      <!-- 保存个人信息 -->
    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="员工照片">
          <!-- 放置上传图片 -->
          <ImageUpload ref="employeesPic" @onSuccess="employeesPicSuccess" />
        </el-form-item>
  ...
  methods: {
    async getPersonalDetail() {
      ...
      if (this.formData.staffPhoto) {
        this.$refs.employeesPic.fileList = [{ url: this.formData.staffPhoto, upload: true }]
      }
    },
    async savePersonal() {
    ...
    async getUserDetailById() {
      ...
      if (this.userInfo.staffPhoto) {
        ...
        this.$refs.employeesHeader.fileList.push({ url: this.userInfo.staffPhoto })
      }
    },
    // 监听员工头像上传成功
